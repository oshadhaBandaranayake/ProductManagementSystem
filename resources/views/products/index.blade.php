...
<body class="bg-gray-100">
    <!-- Success Alert -->
    @if(session('success'))
    <div id="success-alert" class="fixed top-5 right-5 bg-green-500 text-white p-4 rounded-lg mb-4 transition-opacity duration-500 ease-in-out opacity-0 transform translate-y-4" role="alert">
        {{ session('success') }}
    </div>
    @endif
    ...
    <script>
        // success alert animated function
